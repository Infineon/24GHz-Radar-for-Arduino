...
import RadarEquation from './components/RadarEquation';
...
ReactDOM.render(<RadarEquation serialConnectionStore={ serialConnectionStore } serialConsoleStore={ serialConsoleStore } />, domContainer);